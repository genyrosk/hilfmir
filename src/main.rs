...
async fn main() {
    ...
    let google_cloud_api_key =
        std::env::var("GOOGLE_CLOUD_API_KEY").expect("GOOGLE_CLOUD_API_KEY not specified");
    let google_cloud_client = Arc::new(GoogleCloudClient::new(google_cloud_api_key));
